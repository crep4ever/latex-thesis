...
\newcommand{\Star}{\ensuremath{\mbox{\em St}}\xspace}
\newcommand{\Darts}{\ensuremath{\mbox{\em $\mathcal{B}$}}\xspace}
\newcommand{\Regions}{\ensuremath{\mbox{\em $\mathcal{R}$}}\xspace} 
...
%unused
%\newcommand{\Pixels}{\ensuremath{\mbox{\em $\mathcal{X}$}}\xspace} 
...
\newcommand{\cycle}[1]{\ensuremath{\mbox{\em ${#1}^*$}}}
\newcommand{\walk}[1]{\mbox{{\em $(#1)$}-chemin}}
\newcommand{\walks}[1]{\mbox{{\em $(#1)$}-chemins}}
...
\newcommand{\ligne}[1]{\texttt{ligne\,#1}}
\renewcommand{\unit}[1]{\texttt{#1}}
...
\newcommand{\DirectCast}[1]{\ensuremath{\mbox{\em $P_{direct}(#1)$}}}
...
\newcommand{\sizeof}[1]{\ensuremath{\mbox{\em \texttt{taille(}#1\texttt{)}}}}
...
\newcommand{\cf}[1]{(\refsec{#1})}

\newcommand{\ram}[1]{\texttt{ram(#1)}}
\newcommand{\topo}{carte}
\newcommand{\tree}{arbre}
